...
| 카테고리 | 유형 | 상세 설명 | 데이터 수 |
| :--- | :--- | :--- | :--- |
| **Simple** | 단일 호출 | 단일 함수에 대해 1회 호출 수행 (Python/Java/JS) | 550개 |
| **Multiple** | 함수 선택 | 여러 후보 함수 중 최적의 함수 1개를 선택하여 호출 | 200개 |
| **Parallel** | 병렬 호출 | 동일한 함수를 서로 다른 파라미터로 여러 번 동시 호출 | 200개 |
| **Parallel Multiple** | 복합 병렬 | 서로 다른 여러 함수를 동시에 병렬로 호출 | 200개 |
